# Black Forest Labs Generate API

## Overview

This module implements text-to-image generation for Black Forest Labs using the repository-wide normalized public contract. The public function is `generate(prompt, model=None, **kwargs)` and returns `cust_usd`, `base64`, `warnings`, `request_id`.
