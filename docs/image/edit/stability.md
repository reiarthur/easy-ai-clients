# Stability AI Edit API

## Overview

This module implements prompt-guided image editing for Stability AI using the repository-wide normalized public contract. The public function is `edit(prompt, image, model="<lowest_cost_default>", **kwargs)` and returns `cust_usd`, `base64`, `warnings`, `request_id`.
...
- Default model: `stable-image-inpaint`
...
```python
from edit.apis import stability_ai_api

result = stability_ai_api.edit(
