# Fireworks AI Edit API

## Overview

This module implements prompt-guided image editing for Fireworks AI using the repository-wide normalized public contract. The public function is `edit(prompt, image, model="<lowest_cost_default>", **kwargs)` and returns `cust_usd`, `base64`, `warnings`, `request_id`.
...
```python
from edit.apis import fireworks_ai_api

result = fireworks_ai_api.edit(
