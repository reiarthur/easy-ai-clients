# MiniMax Music Lyrics To Song API
...
- Supported technical capabilities: song generation where lyrics are the primary structured input. Provider coverage includes vocal song generation, auto-lyrics, instrumental generation, and cover or re-style from reference audio.
...
- Endpoint or task flow: `ENDPOINT` = `https://api.minimax.io/v1/music_generation`
