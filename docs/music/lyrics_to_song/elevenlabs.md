# ElevenLabs Music Lyrics To Song API
...
- Supported technical capabilities: song generation where lyrics are the primary structured input. Provider coverage includes structured composition, vocal songs, video-to-music, and stem separation.
...
- Endpoint or task flow: `ENDPOINT` = `https://api.elevenlabs.io/v1/music/compose`
