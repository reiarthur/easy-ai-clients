...
- Supported technical capabilities: song generation where lyrics are the primary structured input. Provider coverage includes prompt-to-song, lyrics-to-song, auto-lyrics, remix, extension, inpainting, image-to-song, cover, and voice changer workflows.
