...
- Supported technical capabilities: song generation where lyrics are the primary structured input. Provider coverage includes song generation, instrumental music, AI singing, audio reference, extension, streaming, stems, and voice conversion.
...
- Default model: `v5-song`.
- Endpoint or task flow: `ENDPOINT` = `https://api.soundverse.ai/v5/generate/song`; `STATUS_ENDPOINT` = `https://api.soundverse.ai/v5/status`
...
Current wrapper default: `v5-song`.
