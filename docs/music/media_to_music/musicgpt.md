...
- Supported technical capabilities: music generation guided by image, video, or visual media. Provider coverage includes prompt-to-song, lyrics-to-song, auto-lyrics, remix, extension, inpainting, image-to-song, cover, and voice changer workflows.
...
Current wrapper default: `MusicAI`.
...
- Limitations or warnings: Separate MusicGPT task endpoints by use case to avoid mixed payload contracts. Verify rights and privacy for supplied media.
