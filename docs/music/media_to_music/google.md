# Google Lyria 3 Media To Music API
...
- Supported technical capabilities: music generation guided by image, video, or visual media. Provider coverage includes full-track generation, short clips, loops, vocals, lyrics-to-song, and image-guided music.
...
- Limitations or warnings: Confirm model availability, billing project, and authentication mode before production use. Verify rights and privacy for supplied media.
