# Runware Music Models Music Edit API
...
- Supported technical capabilities: continuation, extension, inpainting, repainting, or repair of existing music. Provider coverage includes MiniMax Music, MiniMax Cover, ACE-Step, text-to-music, lyrics-to-song, audio-guided music, audio-to-audio, and continuation or repainting.
...
- Endpoint or task flow: REST, WebSocket, task API, and Python SDK style workflows. This wrapper path may need explicit endpoint or base URL kwargs before a request can be assembled.
