...
- Supported technical capabilities: continuation, extension, inpainting, repainting, or repair of existing music. Provider coverage includes prompt-to-song, lyrics-to-song, auto-lyrics, remix, extension, inpainting, image-to-song, cover, and voice changer workflows.
...
- Limitations or warnings: Separate MusicGPT task endpoints by use case to avoid mixed payload contracts. Verify rights to the source audio before transformation or editing.
