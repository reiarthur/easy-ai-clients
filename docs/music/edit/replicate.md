# Replicate Hosted Music Models Music Edit API
...
- Supported technical capabilities: continuation, extension, inpainting, repainting, or repair of existing music. Provider coverage includes Python-first hosted music models for text, lyrics, vocals, audio guidance, continuation, and loops.
