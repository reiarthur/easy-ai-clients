# Segmind Music Text To Music API
...
- Supported technical capabilities: prompt-led music generation from a text brief. Provider coverage includes ACE-Step lyrics/vocal generation, Meta MusicGen instrumental clips, parameter control, and loops.
