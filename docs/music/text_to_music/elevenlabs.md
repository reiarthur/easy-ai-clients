...
- Supported technical capabilities: prompt-led music generation from a text brief. Provider coverage includes structured composition, vocal songs, video-to-music, and stem separation.
