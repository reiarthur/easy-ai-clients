# Google Lyria 3 Text To Music API
...
- Supported technical capabilities: prompt-led music generation from a text brief. Provider coverage includes full-track generation, short clips, loops, vocals, lyrics-to-song, and image-guided music.
...
- Endpoint or task flow: REST or official Google Gen AI SDK generation flow. This wrapper path may need explicit endpoint or base URL kwargs before a request can be assembled.
