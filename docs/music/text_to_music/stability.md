# Stability AI Stable Audio Text To Music API
...
- Supported technical capabilities: prompt-led music generation from a text brief. Provider coverage includes instrumental generation, sound design, audio-to-audio, remix variation, loops, and inpainting.
...
- Limitations or warnings: Payload details vary by model and endpoint version.
