# Runware Music Models Text To Music API
...
- Supported technical capabilities: prompt-led music generation from a text brief. Provider coverage includes MiniMax Music, MiniMax Cover, ACE-Step, text-to-music, lyrics-to-song, audio-guided music, audio-to-audio, and continuation or repainting.
