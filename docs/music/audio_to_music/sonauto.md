# Sonauto Melodia Audio To Music API
...
- Supported technical capabilities: music generation or transformation guided by source audio. Provider coverage includes full song, instrumental, lyrics, duration control, audio-guided music, extension, inpainting, streaming, and webhook workflows.
...
- Default model: `v3`.
- Endpoint or task flow: `DEFAULT_BASE_URL` = `https://api.sonauto.ai/v1`
