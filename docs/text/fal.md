# fal.ai OpenRouter bridge Text API Wrapper

## A. Overview
- The wrapper targets the OpenAI-compatible fal.ai route to OpenRouter chat completions.
- Raw generation endpoint: `POST https://fal.run/openrouter/router/openai/v1/chat/completions`.
...
- Create account / console: https://fal.ai/dashboard
- API key docs: https://fal.ai/docs/model-apis/authentication
...
- Public function signature: `generate(input_text, instruction=None, model='google/gemini-2.5-flash', **kwargs)`.
- Current default model: `google/gemini-2.5-flash`.
...
- Tie-break reasoning: google/gemini-2.5-flash was the lowest-cost fal bridge route in this run that returned non-empty text; cheaper free OpenRouter-style IDs were blocked or returned empty text via fal.
...
- Model restrictions: validated for `fal` at family/model level in the validation matrix; unsupported combinations fail provider-side and are recorded as blockers.
...
| deepseek/deepseek-v4-pro | deepseek | failed | router_policy_or_account_setting |
| deepseek/deepseek-v4-flash | deepseek | passed | validated |
...
| nvidia/nemotron-3-super-120b-a12b:free | nvidia | failed | router_policy_or_account_setting |
...
| liquid/lfm-2-24b-a2b | liquid | failed | catalog_listed_but_not_callable_in_endpoint |
...
| minimax/minimax-m2.5:free | minimax | failed | router_policy_or_account_setting |
...
| openrouter/free | openrouter | failed | provider_rate_limit_or_overload |
...
| nvidia/nemotron-3-nano-30b-a3b:free | nvidia | failed | router_policy_or_account_setting |
...
| essentialai/rnj-1-instruct | essentialai | failed | catalog_listed_but_not_callable_in_endpoint |
...
| deepcogito/cogito-v2.1-671b | deepcogito | failed | catalog_listed_but_not_callable_in_endpoint |
...
| nvidia/nemotron-nano-12b-v2-vl:free | nvidia | failed | router_policy_or_account_setting |
| nvidia/nemotron-nano-12b-v2-vl | nvidia | failed | provider_timeout |
...
| baidu/ernie-4.5-21b-a3b-thinking | baidu | failed | provider_rate_limit_or_overload |
...
| nvidia/nemotron-nano-9b-v2:free | nvidia | failed | router_policy_or_account_setting |
...
| openai/gpt-oss-120b:free | openai | failed | router_policy_or_account_setting |
| openai/gpt-oss-120b | openai | passed | validated |
| openai/gpt-oss-20b:free | openai | failed | router_policy_or_account_setting |
...
| google/gemma-3n-e2b-it:free | google | failed | router_policy_or_account_setting |
...
| google/gemma-3n-e4b-it:free | google | failed | router_policy_or_account_setting |
| google/gemma-3n-e4b-it | google | failed | catalog_listed_but_not_callable_in_endpoint |
| mistralai/mistral-medium-3 | mistralai | passed | validated |
| google/gemini-2.5-pro-preview-05-06 | google | passed | validated |
| arcee-ai/spotlight | arcee-ai | failed | catalog_listed_but_not_callable_in_endpoint |
| arcee-ai/maestro-reasoning | arcee-ai | failed | catalog_listed_but_not_callable_in_endpoint |
| arcee-ai/virtuoso-large | arcee-ai | failed | catalog_listed_but_not_callable_in_endpoint |
| arcee-ai/coder-large | arcee-ai | failed | catalog_listed_but_not_callable_in_endpoint |
...
| google/gemma-3-4b-it:free | google | failed | router_policy_or_account_setting |
| google/gemma-3-4b-it | google | passed | validated |
| google/gemma-3-12b-it:free | google | failed | router_policy_or_account_setting |
...
| google/gemma-3-27b-it:free | google | failed | router_policy_or_account_setting |
...
| aion-labs/aion-rp-llama-3.1-8b | aion-labs | failed | provider_rate_limit_or_overload |
...
| inflection/inflection-3-pi | inflection | failed | provider_internal_error |
...
| meta-llama/llama-3-70b-instruct | meta-llama | failed | provider_internal_error |
...
```python
from text.apis import fal

result = fal.generate("Reply with OK.")
...
```python
result = fal.generate("Reply with OK.", model="google/gemini-2.5-flash", max_tokens=64, temperature=0, top_p=1, stop=["END"], stream=True)
```

## J. Pricing section
- Pricing snapshot date: `2026-04-25`.
- Pricing source: see the official references above and the validation artifact `validacao_text_apis_2026-04-25/catalog_fal.json`.
...
- Provider result counts in the final matrix: `{'passed': 263, 'failed': 78}`.
- Failure blocker counts: `{'upstream_provider_rejected_request': 37, 'router_policy_or_account_setting': 13, 'provider_rate_limit_or_overload': 13, 'catalog_listed_but_not_callable_in_endpoint': 11, 'provider_timeout': 1, 'account_or_tier_access_required': 1, 'provider_internal_error': 2}`.
