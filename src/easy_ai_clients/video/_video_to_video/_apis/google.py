...
def generate_video_to_video(
    ...
    **kwargs,
    ...
    extra = {"operation_name": operation_name, "cost_reason": cost["cost_reason"]}
    return build_result(PROVIDER, model, "completed", operation_name, video_url_value, prepared["output_path"], cost["cost_usd"], cost["cost_is_estimated"], cost["cost_source"], operation, extra, download_headers=google_headers(api_key))
