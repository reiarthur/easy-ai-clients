"""Together AI image-to-video wrapper."""
...
def generate_image_to_video(prompt, image_path=None, image_url=None, output_path=None, sync=True, **kwargs):
    ...
    image = common.media(image_path, image_url, "image_path", "image_url")
    if not image:
        raise ValueError("Together image_to_video requires image_path or image_url.")
