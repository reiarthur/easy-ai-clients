...
DEFAULT_MODEL = "minimax-hailuo-2.3-standard-t2v"
...
def _selected_model(kwargs):
    return resolve_model(kwargs.get("model"), DEFAULT_MODEL, "text_to_video")
...
def _build_payload(model_data, prepared, kwargs):
    payload = {
        ...
        "generated_video_inputs": generated_video_inputs(prepared["prompt"], model_data, kwargs),
    }
