"""Google Gemini generate API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.gemini_utils import generate_image as _generate_image
...
def generate(prompt: str, model: str = 'gemini-2.5-flash-image', **kwargs):
    """Generate an image with Google Gemini and return the normalized public contract.
...
validation details are documented in generate/docs/google_gemini_api.md."""
