"""OpenRouter generate API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.openrouter_utils import generate_image as _generate_image
...
def generate(prompt: str, model: str = 'black-forest-labs/flux.2-klein-4b', **kwargs):
    """Generate an image with OpenRouter and return the normalized public contract.
...
validation details are documented in generate/docs/openrouter_api.md."""
