"""Black Forest Labs generate API wrapper."""

from __future__ import annotations

from ..._common.bfl_utils import generate_image as _generate_image
...
_DEFAULTS = {'width': 1024, 'height': 1024, 'output_format': 'png', 'seed': None, 'timeout_seconds': 120}
_EXTRA_KEYS = ('prompt_upsampling', 'safety_tolerance', 'raw', 'guidance', 'steps')


def generate(prompt: str, model: str = 'flux-2-klein-4b', **kwargs):
    """Generate an image with Black Forest Labs and return the normalized public contract.
...
validation details are documented in generate/docs/black_forest_labs_api.md."""
