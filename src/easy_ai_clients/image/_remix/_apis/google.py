"""Google Gemini remix API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.gemini_utils import remix_image as _remix_image
...
_DEFAULTS = {'model': 'gemini-2.5-flash-image', 'base_image': None, 'aspect_ratio': '1:1', 'output_format': 'png', 'timeout_seconds': 120}
_EXTRA_KEYS = ('temperature', 'topP', 'topK', 'candidateCount', 'seed', 'imageConfig')


def remix(prompt: str, reference_images: list[str], **kwargs):
    """Generate a reference-guided image with Google Gemini and return the normalized public contract.
...
validation details are documented in remix/docs/google_gemini_api.md."""
