"""Fireworks AI remix API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.fireworks_utils import remix_image as _remix_image
...
_DEFAULTS = {'model': 'flux-kontext-pro', 'base_image': None, 'aspect_ratio': '1:1', 'output_format': 'png', 'seed': None, 'timeout_seconds': 120}
...
def remix(prompt: str, reference_images: list[str], **kwargs):
    """Generate a reference-guided image with Fireworks AI and return the normalized public contract.
...
validation details are documented in remix/docs/fireworks_ai_api.md."""
