...
from ..._common.together_utils import remix_image as _remix_image
from ..post_processing import build_remix_result
from ..pre_processing import prepare_remix_inputs

_DEFAULTS = {'model': 'black-forest-labs/FLUX.2-dev', 'base_image': None, 'width': 1024, 'height': 1024, 'output_format': 'png', 'seed': None, 'timeout_seconds': 120}
...
def remix(prompt: str, reference_images: list[str], **kwargs):
    """Generate a reference-guided image with Together AI and return the normalized public contract.
...
validation details are documented in remix/docs/together_ai_api.md."""
