"""Google Gemini analyze API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.gemini_utils import analyze_image as _analyze_image
...
_EXTRA_KEYS = ('temperature', 'topP', 'topK', 'maxOutputTokens', 'candidateCount', 'stopSequences', 'responseMimeType', 'responseSchema')


def analyze(prompt: str, image: str, model: str = 'gemini-2.5-flash-lite', **kwargs):
    """Analyze an image with Google Gemini and return the normalized public contract.
...
validation details are documented in analyze/docs/google_gemini_api.md."""
    ...
    generation_config = payload_from_keys(values, ('temperature', 'topP', 'topK', 'maxOutputTokens', 'candidateCount', 'stopSequences', 'responseMimeType', 'responseSchema'))
    try:
