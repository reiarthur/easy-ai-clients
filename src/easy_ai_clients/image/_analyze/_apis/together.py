"""Together AI analyze API wrapper."""
...
from ..._common.together_utils import analyze_image as _analyze_image
...
_EXTRA_KEYS = ('max_tokens', 'temperature', 'top_p', 'top_k', 'repetition_penalty', 'stop', 'tools', 'tool_choice', 'response_format', 'seed')


def analyze(prompt: str, image: str, model: str = 'google/gemma-3n-E4B-it', **kwargs):
    """Analyze an image with Together AI and return the normalized public contract.
...
validation details are documented in analyze/docs/together_ai_api.md."""
    ...
    extra_body = payload_from_keys(values, ('max_tokens', 'temperature', 'top_p', 'top_k', 'repetition_penalty', 'stop', 'tools', 'tool_choice', 'response_format', 'seed'))
