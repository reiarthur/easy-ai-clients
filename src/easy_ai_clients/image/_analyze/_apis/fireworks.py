"""Fireworks AI analyze API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.fireworks_utils import analyze_image as _analyze_image
...
_EXTRA_KEYS = ('max_tokens', 'temperature', 'top_p', 'top_k', 'frequency_penalty', 'presence_penalty', 'stop', 'tools', 'tool_choice', 'response_format')


def analyze(prompt: str, image: str, model: str = 'accounts/fireworks/models/kimi-k2p5', **kwargs):
    """Analyze an image with Fireworks AI and return the normalized public contract.
...
validation details are documented in analyze/docs/fireworks_ai_api.md."""
    ...
    extra_body = payload_from_keys(values, ('max_tokens', 'temperature', 'top_p', 'top_k', 'frequency_penalty', 'presence_penalty', 'stop', 'tools', 'tool_choice', 'response_format'))
