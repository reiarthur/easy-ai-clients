"""Fireworks AI edit API wrapper."""

from __future__ import annotations

from ..._common.env_utils import get_provider_api_key
from ..._common.fireworks_utils import edit_image as _edit_image
...
_DEFAULTS = {'mask': None, 'aspect_ratio': '1:1', 'output_format': 'png', 'seed': None, 'timeout_seconds': 120}
_EXTRA_KEYS = ('strength', 'prompt_upsampling', 'safety_tolerance', 'guidance_scale')


def edit(prompt: str, image: str, model: str = 'flux-kontext-pro', **kwargs):
    """Edit an image with Fireworks AI and return the normalized public contract.
...
validation details are documented in edit/docs/fireworks_ai_api.md."""
    ...
    try:
        prepared = prepare_edit_inputs(prompt, image, provider='fireworks_ai', mask=values["mask"])
        return _edit_image(
