...
from ..._common.xai_utils import edit_image as _edit_image
...
def edit(prompt: str, image: str, model: str = 'grok-imagine-image', **kwargs):
    """Edit an image with xAI and return the normalized public contract.
...
validation details are documented in edit/docs/xai_api.md."""
    ...
    try:
        prepared = prepare_edit_inputs(prompt, image, provider='xai', mask=values["mask"])
        return _edit_image(
